...
struct benchmark_defaults
{
    ...
    static constexpr unsigned const &array_length_step          = 100000;
    static constexpr unsigned const &iterations_per_call_amount = 100;
    static constexpr unsigned const &calls_amount               = 1000;
} static const benchmark_defaults;

class SearchBenchmark {
    unsigned (*search)(int const *, unsigned const, int const);
  ...
  public:
    SearchBenchmark(unsigned (*)(int const *, unsigned const, int const),
